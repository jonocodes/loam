    ...
    >
      ...
      <div style={{ padding: '4px 6px' }}>
        ...
        <button
          ...
          style={{
            width: '100%',
            background: view === 'index' && !activeTag ? theme.sel : 'none',
            border: 'none',
            cursor: 'pointer',
            color: theme.ink,
            padding: '5px 8px',
  ...
  return (
    <button
      ...
      style={{
        ...
        border: 'none',
        cursor: 'pointer',
        color: active ? theme.ink : theme.ink,
        padding: '4px 8px',
        borderRadius: 3,
      ...
      <div style={{ borderTop: `1px solid ${theme.rule}` }}>
        {filtered.map((n) => (
          <button
            ...
            style={{
              display: 'grid',
              gridTemplateColumns: '90px 1fr 70px 90px',
              gap: 16,
              alignItems: 'baseline',
              width: '100%',
              padding: '10px 4px',
  ...
  return (
    <div style={{ padding: '24px 32px 80px', maxWidth: 760 }}>
      ...
      <div style={{ fontSize: 14, lineHeight: 1.7 }}>
        {note.body.map((b, i) => (
          <StackBlock key={i} block={b} theme={theme} onOpen={onOpen} />
        ))}
      </div>
  ...
  if (block.type === 'h2')
    return (
      <h2 style={{ fontSize: 16, fontWeight: 600, margin: '28px 0 12px', letterSpacing: -0.2 }}>
        <span style={{ color: theme.dim, marginRight: 8, fontWeight: 400 }}>##</span>
        {block.text}
      </h2>
    )
  if (block.type === 'ul')
...
function syntaxHighlight(text, _lang, theme) {
  ...
  return (
    <div style={{ display: 'flex', height: '100%', minHeight: 0 }}>
      ...
      >
        ...
        <div style={{ fontSize: 12, color: theme.dim, lineHeight: 1.55 }}>{body.split('\n\n')[0].slice(0, 180)}...</div>
        <button
          onClick={onDone}
          style={{
            marginTop: 24,
